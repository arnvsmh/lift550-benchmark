...
yasunet_v2.py
=============
YASU-Net v2 — Physics-informed turbulence super-resolution.
...
class YASUNetV2(nn.Module):
    ...
    YASU-Net v2 — y+-conditioned Fourier U-Net with:
      ...
      - Post-decoder full-resolution residual refinement (3 ResBlocks)
    ...
    def __init__(
        ...
        modes_h      = 8,
        modes_w      = 8,
        n_refine     = 3,     # number of post-decoder ResBlocks
    ):
        super().__init__()
        b   = base_ch
